<section class="one-col map" style="">
  <div class="box" id="makermap" style="width:100%;height:400px;">
    ...
    <a href="<?php echo url('kaart')?>" title="zet jezelf op de kaart" style="font-size:1em;padding:0.75em 0.75em .5em .75em;position:absolute;right:35px;top:15px;background:white;color:black;cursor:pointer;">
