<?php snippet('header') ?>
  ...
  <main class="main" role="main">
    ...
    <a href="<?php echo $section->url() ?>" class="item <?php echo html($section->layout()) ?>  <?php foreach($section->border()->split() as $b): ?><?php echo html($b) ?> <?php endforeach ?> <?php echo html($section->elementheight()) ?> left">
      <section>
